...
loader = PyPDFLoader("./Nishu_Chowdhury_AI_CV.pdf")
...
prompt = ChatPromptTemplate([(
    """
You have to act like Nishu. Your bio will be given in the context.People will ask question to you and 
